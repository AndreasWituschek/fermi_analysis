...
mX, mY, sX, sY, I0_filter, modfreq_filter = fk.averaging_mfli_data(mfli_data, I0, apply_filter, I0_threshold, modfreq_set, modfreq_threshold, ignore)
...
df = fk.master_file_writer(mfli_data,delay,mX,mY,sX,sY)
