...
WDp = 52.22959528*5; % Seed laser carrier freq., in nm for He 1s4p line
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
max_tau12=7000; % number of points along tau_12 (has to be even)
step_tau = 0.05; % step size along tau in fs
...
wp=wlam/WDp*5; % Pulse carrier frequency, eV
% wp = wp*0.99
...
%         tau12 = ((itau12-1))*step_tau+200;
        ...
        for jt2 = 1:maxJ2
            ...
            Pulse1(jt2,1) = exp(-2*log(2)*((tt2-tau1)/TDp)^2)*exp(1i*WDpw*(tt2-tau1))*exp(1i*phase); %definition of pulse directly in TD with fast oscillating field
        ...
        if ((itau12==1))
            fn_pulse = char(BaseName + "_full_Sa_pulse" + "_amp" + string(amp*100) );
            FileName_pulse = ['//mpmnsh01.public.ads.uni-freiburg.de/mpmnsh01/user/Projekte/BMBF/FERMI/DataAnalysis/Beamtime2/combined/scan_031/simulations/full_Sa/',fn_pulse,'.mat'];
...
%             FX = g1+g2;
    ...
    %data saving
    fn = char(BaseName + "_full_Sa" + "_amp" + string(amp*100) + "_" + string(value));
    FileName = ['//mpmnsh01.public.ads.uni-freiburg.de/mpmnsh01/user/Projekte/BMBF/FERMI/DataAnalysis/Beamtime2/combined/scan_031/simulations/full_Sa/',fn,'.mat'];
...
figure('Name','Pulses');
plot(1:length(Pulse1),real(Pulse1))
