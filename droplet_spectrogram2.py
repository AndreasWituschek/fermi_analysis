...
data_window = [-1,2]   # which part of the interferogram should be considered in ps
t_lim = [0,1.5]
wn_lim = [10000,15000]
mono_calib = 12496.491 #13068.815  #calibrated mono value in cm^-1, if this is 0.0, sktript will use value from rpt-file + mono_corr
...
T, Z1TE, Z2TE, para_dict = import_data2() # returns T in fs
Te, Z1E, Z2E, para_dict = import_data2() # returns T in fs

Z1 = np.array(Z1TE)-np.array(Z1E) # signal chopper open minus signal chopper closed
Z2 = np.array(Z2TE)-np.array(Z2E) # signal chopper open minus signal chopper closed
